...
var_epu <- VAR(df_epu_2_ts, 2, 'none')
...
# формирование 
var_tot_share_price <- VAR(df_tot_share_price_2_ts, 2, 'none')
...
var_usd_ruble <- VAR(df_usd_ruble_2_ts, 2, 'none')
...
# формирование векторной авторегрессии
var_macro_uncert <- VAR(df_macro_uncert_2_ts, 2, 'none')
...
# формирование векторной авторегрессии
var_pca_all_uncer_feat <- VAR(df_pca_all_uncer_feat_2_ts, 2, 'none')
# проверка причинности
